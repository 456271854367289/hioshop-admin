          ...
          <div v-for="item in tableData" class="list-wrap clearfix">
            ...
            <div class="content-wrap clearfix">
              ...
              <div class="user-wrap">
                ...
                <div class="mobile">手机：{{ item.mobile }}</div>
              </div>
              <div class="main">
              ...
              <div class="right">
                ...
                <!-- || item.order_status == 301 -->
                <el-button
                  v-if="
                    item.offline_pay === 1 && item.order_status == 101
                      ? true
                      : item.order_status == 300
                  "
                  size="mini"
                ...
                <el-button
                  v-else-if="item.order_status == 101"
                  size="mini"
                  @click="orderEdit(item)"
...
export default {
  ...
  methods: {
    ...
    orderEdit(item) {
      ...
      if (item.order_status == 300 || item.order_status == 301 || item.offline_pay === 1) {
        this.rePrintStatus = 0;
